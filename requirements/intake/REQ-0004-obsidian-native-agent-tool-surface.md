...
acceptance_criteria:
  ...
  - "A concrete in-plugin MCP server implementation registers the full tool catalogue: 7 vault tools, 4 frontmatter tools, 5 links/graph tools, 6 canvas tools, 5 bases tools, 6 workflow tools, 3 metadata tools (35 total) — names exactly matching the catalogue in #165."
