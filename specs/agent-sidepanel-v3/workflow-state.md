...
| 2026-05-17 | dev | dev | **WP-1 merged** (PR [#397](https://github.com/Luis85/specorator/pull/397)). WP-11 (subprocess adapter split — Lifecycle / NdjsonChannel / runStructured) and WP-12 (ClaudeCliPort surface cleanup — `queryStream`-only + lifecycle split) both unblocked and dispatched in parallel on the Spine lane. Three implementers in flight: WP-2 (Store + UX), WP-11 (Spine), WP-12 (Spine). |
