...
import { backupPathFor, writeBackup } from "../../src/catalog/backup";
import { memFs } from "./memfs";

describe("backup", () => {
  it("derives a timestamped .bak path (no clobber on repeat)", () => {
    const ts = "2026-05-25T12-00-00-000Z";
    expect(backupPathFor(".claude/skills/x/SKILL.md", ts))
      .toBe(".claude/skills/x/SKILL.md.2026-05-25T12-00-00-000Z.bak");
  });
