...
import { loadState, saveRecord, removeRecord, SIDECAR_PATH } from "../../src/catalog/sidecar";
...
describe("sidecar", () => {
  ...
  it("round-trips a record", async () => {
    ...
    await saveRecord(fs, "auditing-vault", {
      version: "0.1.0", platforms: ["claude"],
      paths: [".claude/skills/auditing-vault/SKILL.md"], hash: "abc",
    });
