...
import { loadBundledCatalog } from "../../src/catalog/source";

const indexJson = JSON.stringify({
  version: "0.1.0",
  assets: [{
    id: "auditing-vault", name: "auditing-vault", description: "d",
    type: "skill", version: "0.1.0", bundle: "Vault Audit",
    requires: [], dependsOn: [], body: "# Body",
  }],
});
