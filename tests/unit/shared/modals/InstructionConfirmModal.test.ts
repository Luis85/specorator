...
function clickButton(root: any, text: string): void {
  const buttons = findAllByClass(root, 'specorator-instruction-btn');
...
describe('InstructionModal', () => {
  describe('onOpen', () => {
    it('renders the raw instruction text', () => {
      ...
      const originalEl = findByClass(contentEl, 'specorator-instruction-original');
    ...
    it('starts in loading state', () => {
      ...
      const loadingEl = findByClass(contentEl, 'specorator-instruction-loading');
      expect(loadingEl).not.toBeNull();
      expect(loadingEl.hasClass('specorator-hidden')).toBe(false);

      const clarificationEl = findByClass(contentEl, 'specorator-instruction-clarification-section');
      expect(clarificationEl.hasClass('specorator-hidden')).toBe(true);

      const confirmationEl = findByClass(contentEl, 'specorator-instruction-confirmation-section');
      expect(confirmationEl.hasClass('specorator-hidden')).toBe(true);
    });
    ...
    it('renders Cancel button in loading state', () => {
      ...
      const buttons = findAllByClass(contentEl, 'specorator-instruction-btn');
  ...
  describe('showClarification', () => {
    it('transitions to clarification state', () => {
      ...
      const loadingEl = findByClass(contentEl, 'specorator-instruction-loading');
      expect(loadingEl.hasClass('specorator-hidden')).toBe(true);

      const clarificationEl = findByClass(contentEl, 'specorator-instruction-clarification-section');
      expect(clarificationEl.hasClass('specorator-hidden')).toBe(false);
    });
    ...
    it('displays the clarification text', () => {
      ...
      const clarificationTextEl = findByClass(contentEl, 'specorator-instruction-clarification');
  ...
  describe('showConfirmation', () => {
    it('transitions to confirmation state', () => {
      ...
      const confirmationEl = findByClass(contentEl, 'specorator-instruction-confirmation-section');
      expect(confirmationEl.hasClass('specorator-hidden')).toBe(false);
    });
    ...
    it('displays the refined instruction', () => {
      ...
      const refinedEl = findByClass(contentEl, 'specorator-instruction-refined');
