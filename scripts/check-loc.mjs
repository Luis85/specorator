 ...
 * ones. CI had no objective gate for file-size drift, so the convention was
 * purely social (see docs/tech-debt/2026-06-07-agentic-quality-gates.md and
...
const DEFAULT_REASON =
  'Grandfathered hotspot. Track the split in ' +
  'docs/tech-debt/2026-06-07-oversized-modules-and-test-files.md; shrink only.';
...
if (asJson) {
  console.error(JSON.stringify({ maxLoc: MAX_LOC, newOverCap, grown, stale }, null, 2));
} else {
