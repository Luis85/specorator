export default {
	...
	settings: {
		...
		approvalRules: {
			...
			empty:
				'No approval rules saved yet. Use "Always allow" on a tool-permission card to create one.',
			remove: 'Remove',
	...
	agent: {
		...
		newConversationConfirmBody:
			"This clears the current conversation's messages. Your draft is preserved. Hold Shift to skip this confirmation next time.",
