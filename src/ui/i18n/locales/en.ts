export default {
  ...
  status: {
    ...
    bashHeading: 'Bash history',
    bashEmpty: 'No bash invocations yet.',
    bashExpand: 'Show output',
    bashCollapse: 'Hide output',
    bashTruncated: 'Output truncated',
  },
  mode: {
    plan: 'Plan mode',
    planOn: 'Plan mode on',
    planOff: 'Plan mode off',
    bangBash: 'Bash command (sent verbatim)',
    instruction: 'System instruction',
  },
  attachment: {
    tooLarge: 'Attachment exceeds the 5 MB limit.',
    remove: 'Remove {label}',
    stripAriaLabel: 'Pending attachments',
  },
  provider: {
    badge: 'Provider',
    menuAriaLabel: 'Choose provider',
    claude: 'Claude',
    cursor: 'Cursor',
    model: 'Model',
  },
