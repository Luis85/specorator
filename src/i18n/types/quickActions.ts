export type QuickActionsTranslationKey =
  ...
  | 'quickActions.library.tab'
  | 'quickActions.library.title'
  | 'quickActions.library.newAction'
  | 'quickActions.library.actionFailed'
  | 'quickActions.library.run'
  | 'quickActions.library.edit'
  | 'quickActions.library.duplicate'
  | 'quickActions.library.delete'
  | 'quickActions.library.deleteConfirm'
  | 'quickActions.library.deleted'
  | 'quickActions.library.favoriteAria'
  | 'quickActions.library.favoriteLimit'
  | 'quickActions.library.folderNotConfigured'
  ...
  | 'quickActions.modal.tabs.commands'
  ...
  | 'quickActions.commands.emptyAll'
  | 'quickActions.commands.emptyHint'
  | 'quickActions.commands.providerDisabled'
  | 'quickActions.commands.disabledBadge'
